...
<div class="pane-desc">
  ...
  <p class="meta-date"><?php print strip_tags($row->_field_data['nid']['entity']->field_date_time_text['und'][0]['value']); ?>
  <br /><?php print strip_tags($row->field_field_time[0]['rendered']); ?></p>
